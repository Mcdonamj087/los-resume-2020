# A MMD Fork of Chris Ferdinandi's Gulp Boilerplate
...
- Compiles Nunjucks to html in `dist` directory.
- Optimize SVGs.
...
2. Run `ncu` to check if any dependencies in package.json are out of date. 
3. Run `ncu -u` to update them all.
4. Run `npm install` to install required files and dependencies.
